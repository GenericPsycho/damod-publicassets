...
dialog = [dialog_create("alright lets fight", -4, function() //gml_Script_anon_gml_RoomCC_hub_pizzatowercomplex_6_Create_92_gml_RoomCC_hub_pizzatowercomplex_6_Create
{
