...
function lang_read_file(argument0) //gml_Script_lang_read_file
{
...
{
    var str = lang_read_file(argument0)
...
function lang_get_value_newline_raw(argument0, argument1) //gml_Script_lang_get_value_newline_raw
{
    return string_replace_all(lang_get_value_raw(argument0, argument1), "\\n", "\n");
}
