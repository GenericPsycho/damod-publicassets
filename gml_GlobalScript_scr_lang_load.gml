function scr_lang_load_init() //gml_Script_scr_lang_load_init
{
...
function lang_load_fonts(argument0) //gml_Script_lang_load_fonts
{
    var lang = ds_map_find_value(global.lang_map, argument0)
    if ds_map_find_value(lang, "custom_fonts")
    {
        ds_map_set(global.font_map, concat("tutorialfont_", argument0), lang_get_custom_font("tutorialfont", lang))
        ds_map_set(global.font_map, concat("creditsfont_", argument0), lang_get_custom_font("creditsfont", lang))
        ds_map_set(global.font_map, concat("bigfont_", argument0), lang_get_custom_font("bigfont", lang))
        ds_map_set(global.font_map, concat("smallfont_", argument0), lang_get_custom_font("smallfont", lang))
        ds_map_set(global.font_map, concat("captionfont_", argument0), lang_get_custom_font("captionfont", lang))
    }
}

function lang_unload_font(argument0) //gml_Script_lang_unload_font
{
    var lang = ds_map_find_value(global.lang_map, argument0)
    if ds_map_find_value(lang, "custom_fonts")
    {
        font_delete(ds_map_find_value(global.font_map, concat("tutorialfont_", argument0)))
        font_delete(ds_map_find_value(global.font_map, concat("creditsfont_", argument0)))
        font_delete(ds_map_find_value(global.font_map, concat("bigfont_", argument0)))
        font_delete(ds_map_find_value(global.font_map, concat("smallfont_", argument0)))
        font_delete(ds_map_find_value(global.font_map, concat("captionfont_", argument0)))
    }
}

function scr_lang_load_update() //gml_Script_scr_lang_load_update
{
    if (global.offload_lang != -4 && global.offload_lang != "en")
    {
