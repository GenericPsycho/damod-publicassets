...
for (var _ind = 0; _ind < _count; _ind++)
{
    ...
    array_set(_mntr, 0, buffer_read(_buf, buffer_s32))
    array_set(_mntr, 1, buffer_read(_buf, buffer_s32))
    array_set(_mntr, 2, buffer_read(_buf, buffer_s32))
    array_set(_mntr, 3, buffer_read(_buf, buffer_s32))
    array_set(_work, 0, buffer_read(_buf, buffer_s32))
    array_set(_work, 1, buffer_read(_buf, buffer_s32))
    array_set(_work, 2, buffer_read(_buf, buffer_s32))
    array_set(_work, 3, buffer_read(_buf, buffer_s32))
    array_set(_item, 2, buffer_read(_buf, buffer_s32))
}
