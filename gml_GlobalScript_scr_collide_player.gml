...
function scr_collide_player() //gml_Script_scr_collide_player
{
    ...
    grounded |= grinding
    if (platformid != noone || (place_meeting(x, (y + 1), obj_movingplatform) && (!(place_meeting(x, (y - 3), obj_movingplatform)))) || place_meeting(x, (y + 8), (204 && (!(place_meeting(x, (y + 6), obj_movingplatform))))))
        grounded = true
