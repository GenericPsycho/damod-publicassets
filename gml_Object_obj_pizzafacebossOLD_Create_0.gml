...
hitplayer = false
function player_hurt(argument0, argument1) //gml_Script_player_hurt_gml_Object_obj_pizzafacebossOLD_Create_0
{
...
function boss_hurt(argument0, argument1) //gml_Script_boss_hurt_gml_Object_obj_pizzafacebossOLD_Create_0
{
    if (phase == 0)
...
function boss_hurt_noplayer(argument0) //gml_Script_boss_hurt_noplayer_gml_Object_obj_pizzafacebossOLD_Create_0
{
    if (inv_timer <= 0)
    {
        hp -= argument0
