...
array_sort(_categories, function(argument0, argument1) //gml_Script_anon_gml_RoomCC_editor_room_1_Create_318_gml_RoomCC_editor_room_1_Create
{
...
for (i = 0; i < array_length(_categories); i++)
{
    ...
    with (instance_create_depth(0, (32 * i), (depth - 1), obj_button))
    {
        ...
        image_xscale = 0.5
        image_yscale = 0.5
        on_left_click = function() //gml_Script_anon_gml_RoomCC_editor_room_1_Create_690_gml_RoomCC_editor_room_1_Create
        {
            with (obj_itemlist)
            {
                if (ID == obj_hardmode)
...
with (instance_create_depth(32, 0, (depth - 1), obj_itemlist))
{
    ...
    ID = obj_hardmode
    item_height = 48
    on_dirty = function() //gml_Script_anon_gml_RoomCC_editor_room_1_Create_1102_gml_RoomCC_editor_room_1_Create
    {
        dirty = false
        ds_list_clear(items)
    ...
    on_item_click = function(argument0) //gml_Script_anon_gml_RoomCC_editor_room_1_Create_1326_gml_RoomCC_editor_room_1_Create
    {
    ...
    on_item_draw = function(argument0, argument1, argument2) //gml_Script_anon_gml_RoomCC_editor_room_1_Create_1582_gml_RoomCC_editor_room_1_Create
    {
        if (draw_get_font() != 0)
