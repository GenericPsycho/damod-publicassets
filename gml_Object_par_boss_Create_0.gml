...
colliding = true
function SUPER_player_destroy(argument0) //gml_Script_SUPER_player_destroy_gml_Object_par_boss_Create_0
{
...
function SUPER_boss_destroy(argument0) //gml_Script_SUPER_boss_destroy_gml_Object_par_boss_Create_0
{
    destroyed = true
    depth = argument0.depth
...
function SUPER_boss_hurt(argument0, argument1) //gml_Script_SUPER_boss_hurt_gml_Object_par_boss_Create_0
{
    if important
        hp -= argument0
...
function SUPER_boss_hurt_noplayer(argument0) //gml_Script_SUPER_boss_hurt_noplayer_gml_Object_par_boss_Create_0
{
    if important
        hp -= argument0
...
function SUPER_player_hurt(argument0, argument1) //gml_Script_SUPER_player_hurt_gml_Object_par_boss_Create_0
{
...
function player_destroy(argument0) //gml_Script_player_destroy_gml_Object_par_boss_Create_0
{
    self.SUPER_player_destroy(argument0)
}

function boss_destroy(argument0) //gml_Script_boss_destroy_gml_Object_par_boss_Create_0
{
    self.SUPER_boss_destroy(argument0)
}

function player_hurt(argument0, argument1) //gml_Script_player_hurt_gml_Object_par_boss_Create_0
{
    self.SUPER_player_hurt(argument0, argument1)
}

function boss_hurt(argument0, argument1) //gml_Script_boss_hurt_gml_Object_par_boss_Create_0
{
    self.SUPER_boss_hurt(argument0, argument1)
}

function boss_hurt_noplayer(argument0) //gml_Script_boss_hurt_noplayer_gml_Object_par_boss_Create_0
{
