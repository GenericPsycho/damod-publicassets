...
{
    notification_push((43 << 0), [sjumptimer, room])
    sjumptimer = 0
}
if (invtime > 0)
    invtime--
...
if (movespeed > 12 && abs(hsp) > 12 && state == states.mach3 && state != states.slipbanan && (!instance_exists(speedlineseffectid)) && (!cutscene) && (collision_flags & (1 << 0)) <= 0)
{
