...
spd = 25
parryable = true
function player_hurt(argument0, argument1) //gml_Script_player_hurt_gml_Object_obj_revolvershot_Create_0
{
    if (!collisioned)
    {
...
function parry() //gml_Script_parry_gml_Object_obj_revolvershot_Create_0
{
