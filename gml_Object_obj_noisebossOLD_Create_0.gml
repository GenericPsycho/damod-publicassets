...
attack_pool[2] = [states.handstandjump, states.throwing, states.throwkick]
attack_pool[3] = [states.pogo, (169 << 0)]
attack_pool[4] = [states.jetpackstart, (172 << 0), (173 << 0)]
attack_pool[5] = [states.handstandjump, states.jump, states.skateboard, (167 << 0), states.throwing, states.throwkick, states.pogo, (169 << 0), states.jetpackstart, (172 << 0), (173 << 0)]
attack_pool[6] = [states.handstandjump, states.jump, states.skateboard, (167 << 0)]
attack_pool[7] = [states.handstandjump, states.throwing, states.throwkick, states.pogo, (169 << 0)]
attack_pool[8] = [states.jetpackstart, (172 << 0), (173 << 0)]
...
function boss_destroy(argument0) //gml_Script_boss_destroy_gml_Object_obj_noisebossOLD_Create_0
{
...
function boss_hurt(argument0, argument1) //gml_Script_boss_hurt_gml_Object_obj_noisebossOLD_Create_0
{
    if (targetstunned > 0)
    {
...
function boss_hurt_noplayer(argument0) //gml_Script_boss_hurt_noplayer_gml_Object_obj_noisebossOLD_Create_0
{
    if (targetstunned > 0)
    {
        targetstunned -= targetstunnedminus[(phase - 1)]
...
function player_hurt(argument0, argument1) //gml_Script_player_hurt_gml_Object_obj_noisebossOLD_Create_0
{
