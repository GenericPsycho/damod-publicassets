function lang_sprites_parse(argument0) //gml_Script_lang_sprites_parse
{
    ...
    for (var i = 0; i < array_length(arr); i++)
    {
        ...
        {
            ds_map_set(ds_map_find_value(global.lang_sprite_map, argument0), asset, spr)
...
function lang_draw_sprite_ext(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) //gml_Script_lang_draw_sprite_ext
{
    ...
    if (spr != -4)
    {
        ...
        var frame = lang_get_frame(spr, argument1)
...
function lang_get_frame(argument0, argument1) //gml_Script_lang_get_frame
{
    if (argument0 == noone || array_length(argument0.frames) == 0)
        return -4;
    argument1 = floor(argument1)
    argument1 %= array_length(argument0.frames)
    if (argument1 < 0)
        argument1 = 0
    if (argument1 > (array_length(argument0.frames) - 1))
        argument1 = array_length(argument0.frames) - 1
    return argument0.frames[argument1];
}
