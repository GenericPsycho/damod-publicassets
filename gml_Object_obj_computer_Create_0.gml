...
var _palettes = ["unfunny", "money", "sage", "blood", "tv", "dark", "shitty", "golden", "garish", "mooney", "funny", "itchy", "pizza", "stripes", "goldemanne", "bones", "pp", "war", "john", "boise", "roise", "poise", "reverse", "critic", "outlaw", "antidoise", "flesheater", "super", "porcupine", "feminine", "realdoise", "forest", "racer", "comedian", "banana", "noiseTV", "madman", "bubbly", "welldone", "grannykisses", "towerguy"]
...
update_text = function() //gml_Script_anon_gml_Object_obj_computer_Create_0_2432_gml_Object_obj_computer_Create_0
{
    if (text == 0)
    {
